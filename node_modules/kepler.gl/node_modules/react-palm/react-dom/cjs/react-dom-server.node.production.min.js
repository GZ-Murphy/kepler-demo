...
var x = 'function' === typeof Symbol && Symbol.for,
    ...
    ca = x ? Symbol.for('react.placeholder') : 60113;
...
function fa(a, b, d, c) {
  if (null === b || 'undefined' === typeof b || ea(a, b, d, c)) return !0;
  if (c) return !1;
...
function va(a, b) {
  function d(c, g) {
    ...
    if ('function' === typeof e.getChildContext && (d = g.childContextTypes, 'object' === _typeof(d))) {
      ...
      for (var w in c) {
        w in d ? void 0 : t('108', I(g) || 'Unknown', w);
      }
    }
...
var Y = function () {
  ...
  a.prototype.render = function (a, d, c) {
    ...
    t('130', null == b ? b : _typeof(b), '');
  };

  a.prototype.renderDOM = function (a, d, c) {
    var b = a.type.toLowerCase();
    c === S.html && T(b);
    oa.hasOwnProperty(b) || (na.test(b) ? void 0 : t('65', b), oa[b] = !0);
    var f = a.props;
    if ('input' === b) f = p({
      type: void 0
    }, f, {
      ...
      if (null == k) {
        k = f.defaultValue;
        var l = f.children;
        null != l && (null != k ? t('92') : void 0, Array.isArray(l) && (1 >= l.length ? void 0 : t('93'), l = l[0]), k = '' + l);
        null == k && (k = '');
      }
    ...
    if (k = f) ia[b] && (null != k.children || null != k.dangerouslySetInnerHTML ? t('137', b, '') : void 0), null != k.dangerouslySetInnerHTML && (null != k.children ? t('60') : void 0, 'object' === _typeof(k.dangerouslySetInnerHTML) && '__html' in k.dangerouslySetInnerHTML ? void 0 : t('61')), null != k.style && 'object' !== _typeof(k.style) ? t('62', '') : void 0;
    k = f;
    ...
    for (u in k) {
      if (sa.call(k, u)) {
        ...
        if (null != e) {
          if ('style' === u) {
            ...
            for (h in e) {
              if (e.hasOwnProperty(h)) {
                ...
                if (null != n) {
                  var w = h;
                  if (X.hasOwnProperty(w)) w = X[w];else {
                    var za = w.replace(ka, '-$1').toLowerCase().replace(la, '-ms-');
                    w = X[w] = za;
                  }
                  v += r + w + ':';
                  r = h;
                  m = null == n || 'boolean' === typeof n || '' === n ? '' : m || 'number' !== typeof n || 0 === n || V.hasOwnProperty(r) && V[r] ? ('' + n).trim() : n + 'px';
                  v += m;
                  r = ';';
                }
              }
          ...
          if (m) ta.hasOwnProperty(u) || (h = u, h = M(h) && null != e ? h + '=' + ('"' + R(e) + '"') : '');else {
            m = u;
            h = e;
            e = O.hasOwnProperty(m) ? O[m] : null;
            if (n = 'style' !== m) n = null !== e ? 0 === e.type : !(2 < m.length) || 'o' !== m[0] && 'O' !== m[0] || 'n' !== m[1] && 'N' !== m[1] ? !1 : !0;
            n || fa(m, h, e, !1) ? h = '' : null !== e ? (m = e.attributeName, e = e.type, h = 3 === e || 4 === e && !0 === h ? m + '=""' : m + '=' + ('"' + R(h) + '"')) : h = M(m) ? m + '=' + ('"' + R(h) + '"') : '';
          }
          h && (z += ' ' + h);
        }
      }
    ...
    var u = z;
    k = '';
    U.hasOwnProperty(b) ? u += '/>' : (u += '>', k = '</' + a.type + '>');
...
var xa = function (a) {
  function b(d, c) {
    ...
    g = !g || 'object' !== _typeof(g) && 'function' !== typeof g ? this : g;
    g.partialRenderer = new Y(d, c);
    return g;
  }
