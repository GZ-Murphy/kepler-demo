...
(function (k, n) {
  'object' === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && 'undefined' !== typeof module ? module.exports = n(require('react'), require('react-dom')) : 'function' === typeof define && define.amd ? define(['react', 'react-dom'], n) : k.ReactTestUtils = n(k.React, k.ReactDOM);
})(void 0, function (k, n) {
  ...
  function m(a) {
    ...
    A(!1, 'Minified React error #' + a + '; visit %s for the full message or use the non-minified dev environment for full errors and additional helpful warnings. ', c);
  }
  ...
  function t(a, b, c, e) {
    ...
    this.isDefaultPrevented = (null != c.defaultPrevented ? c.defaultPrevented : !1 === c.returnValue) ? w : x;
  ...
  function P(a) {
    a instanceof this ? void 0 : A(!1, 'Trying to release an event instance into a pool of a different type.');
    a.destructor();
  ...
  function z(a) {
    ...
    for (c in b) {
      if (b.hasOwnProperty(c) && c in G) return B[a] = b[c];
    }
  ...
  function p(a, b) {
    if (a && !a._reactInternalFiber) {
      ...
      A(!1, '%s(...): the first argument must be a React class instance. Instead received: %s.', b, a);
    }
  }
  ...
  function R(a) {
    return function (b, c) {
      ...
      g.persist();
      u(g, c);
      e.phasedRegistrationNames ? J.accumulateTwoPhaseDispatches(g) : J.accumulateDirectDispatches(g);
  ...
  function C() {
    ...
    for (a in I.eventNameDispatchConfigs) {
      f.Simulate[a] = R(a);
    }
  }
  ...
  function T(a, b) {
    return function (c, e) {
      var d = new H(a);
      u(d, e);
      f.isDOMComponent(c) ? (c = U(c), d.target = c, L.dispatchEvent(b, d)) : c.tagName && (d.target = c, L.dispatchEvent(b, d));
    };
  }
  ...
  u(t.prototype, {
    preventDefault: function preventDefault() {
      ...
      a && (a.preventDefault ? a.preventDefault() : 'unknown' !== typeof a.returnValue && (a.returnValue = !1), this.isDefaultPrevented = w);
    },
    stopPropagation: function stopPropagation() {
      var a = this.nativeEvent;
      a && (a.stopPropagation ? a.stopPropagation() : 'unknown' !== typeof a.cancelBubble && (a.cancelBubble = !0), this.isPropagationStopped = w);
    },
  ...
  var l = !('undefined' === typeof window || !window.document || !window.document.createElement),
    ...
    transitionend: y('Transition', 'TransitionEnd')
      ...
      B = {},
      G = {};
  l && (G = document.createElement('div').style, 'AnimationEvent' in window || (delete q.animationend.animation, delete q.animationiteration.animation, delete q.animationstart.animation), 'TransitionEvent' in window || delete q.transitionend.transition);
  l = z('animationend');
    ...
    scryRenderedDOMComponentsWithClass: function scryRenderedDOMComponentsWithClass(a, b) {
      ...
      return f.findAllInRenderedTree(a, function (a) {
        if (f.isDOMComponent(a)) {
          ...
          var d = c.split(/\s+/);
          Array.isArray(b) || (void 0 === b ? m('11') : void 0, b = b.split(/\s+/));
