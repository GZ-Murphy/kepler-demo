...
if (process.env.NODE_ENV !== 'production') {
  (function () {
    ...
    var stream = require('stream'); // TODO: this is special because it gets imported during build.
    ...
    null); // code copied and modified from escape-html
    ...
    var ReactDOMServerRenderer = function () {
      ...
      function ReactDOMServerRenderer(children, makeStaticMarkup) {
        ...
        this.makeStaticMarkup = makeStaticMarkup; // Context (new API)
      ...
      ReactDOMServerRenderer.prototype.pushProvider = function pushProvider(provider) {
        ...
        var previousValue = context._currentValue; // Remember which value to restore this context to on our way up.
